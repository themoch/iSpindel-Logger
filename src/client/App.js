    ...
    return (
      <div>
            ...
            {iSpindels.map((iSpindel) => (
              <div className="card">
                <h2>
                  ...
                  {' - '}
                  <span> {moment(iSpindel.time).format('hh:mm:ss a')}</span>
                </h2>
                <div className="info">
                  <div className="row">
                    <div className="left"><strong>Time</strong></div>
                    <div className="right"><strong>{moment(iSpindel.time).format('hh:mm:ss a')}</strong></div>
                  </div>
                  <div className="row">
                  ...
                  <div className="row">
                    <a href={`./${iSpindel.name}_${iSpindel.ID}.csv`}>Download CSV</a>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="footer">
          Created by:
          {' '}
          <a href="https://github.com/themoch/">themoch</a>
          {' '}
          <br />
          Fork on Github:
          {' '}
          <a href="https://github.com/themoch/iSpindel-Logger">https://github.com/themoch/iSpindel-Logger</a>
          {' '}
          <br />
          iSpindel Project:
          {' '}
          <a href="http://www.ispindel.de/">http://www.ispindel.de/</a>
        </div>
      </div>
    );
  }
